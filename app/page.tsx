...
import { Globe, Zap, Brain, FileSpreadsheet, Cloud, Smartphone, LucideIcon } from 'lucide-react';
...
interface Feature {
  name: string;
  description: string;
  Icon: LucideIcon;  // Change this to LucideIcon type
}
...
const features: Feature[] = [
  {
    ...
    Icon: Globe  // Use the icon component directly
  },
  {
...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5  bg-gradient-to-bl from-white to-indigo-600">
      <div className='bg-white py-24 sm:py-32 rounded-md drop-d-xl'>
        <div className='flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-7'>
